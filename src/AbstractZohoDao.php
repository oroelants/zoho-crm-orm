...
abstract class AbstractZohoDao
{
   ...
   * @param array|null                $wfTrigger Array of triggers to call related to a
   *                                       "created" event
   * @param string              $action
   *
   * @return array
   ...
   */
  public function createOrUpdate(array $beans, ?array $wfTrigger = null, $action = 'upsert'): array
  {
    /**
   ...
   * @throws \zcrmsdk\crm\exception\ZCRMException
   */
  public function insertRecords(array $beans, ?array $wfTrigger = null): array
  {
   ...
   * @throws \zcrmsdk\crm\exception\ZCRMException
   */
  public function updateRecords(array $beans, ?array $wfTrigger = null): array
  {
   ...
   * @throws \zcrmsdk\crm\exception\ZCRMException
   */
  public function save($beans, ?array $wfTrigger = null): array
  {
  ...
  public function getFieldFromFieldName($fieldName)
  {
    ...
    $field = array_values(
      array_filter(
        $fields,
        function (Field $fiedObj) use ($fieldName) {
